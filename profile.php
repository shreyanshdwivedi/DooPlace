        ...
        <div class="col-sm-12 col-md-3">
            <ul style="list-style:none; font-family: Circular,'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; color: #484848; float: right;">
                <li style=" text-decoration: none;">
                    <a href="profile.php?section=edit" style="display: block; padding: 6px 0; font-size: 16px; color: #484848;" class="profileActive">
                        Edit Profile
                    </a>
                </li>
                <li style=" text-decoration: none;">
                    <a href="profile.php?section=image" style="display: block; padding: 6px 0; font-size: 16px; color: #484848;">
                        Photos
                    </a>
                </li>
                <li style=" text-decoration: none;">
                    <a href="profile.php?section=verification" style="display: block; padding: 6px 0; font-size: 16px; color: #484848;">
                        Trust and Verification
                    </a>
                </li>
                <li style=" text-decoration: none;">
                    <a href="profile.php?section=reviews" style="display: block; padding: 6px 0; font-size: 16px; color: #484848;">
                        Reviews
                    </a>
                </li>
                <li>
                    <a href="viewProfile.php" class="btn btn-default" style="width: 100%;">View Profile</a>
                </li>
            </ul>
        </div>
...
<br/><br/>
    <div class="row container">
        <div class="col-sm-12 col-md-3">
            <ul style="list-style:none; font-family: Circular,'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; color: #484848; float: right;">
                <li style=" text-decoration: none;">
                    <a href="profile.php?section=edit" style="display: block; padding: 6px 0; font-size: 16px; color: #484848;">
                        Edit Profile
                    </a>
                </li>
                <li style=" text-decoration: none;">
                    <a href="profile.php?section=image" style="display: block; padding: 6px 0; font-size: 16px; color: #484848;" class="profileActive">
                        Photos
                    </a>
                </li>
                <li style=" text-decoration: none;">
    ...
    <div class="row container">
        <div class="col-sm-12 col-md-3">
            <ul style="list-style:none; font-family: Circular,'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; color: #484848; float: right;">
                ...
                <li style=" text-decoration: none;">
                    <a href="profile.php?section=reviews" style="display: block; padding: 6px 0; font-size: 16px; color: #484848;" class="profileActive">
                        Reviews
                    </a>
                </li>
                <li>
        ...
        <div class="col-sm-12 col-md-9">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#aboutYou">Reviews About You</a></li>
                <li><a data-toggle="tab" href="#byYou">Reviews By You</a></li>
            </ul>
            <br/>
            <div class="tab-content">
                <div id="aboutYou" class="tab-pane fade in active">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Past Reviews</h3>
                        </div>
                        <div class="panel-body">
                            Reviews are written at the end of a reservation through Airbnb. 
                            Reviews you’ve received will be visible both here and on your public profile.<br/>
                            No one has reviewed you yet. 
                        </div>
                    </div>
                </div>
                <div id="byYou" class="tab-pane fade">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Reviews To Write</h3>
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Past Reviews You’ve Written </h3>
                        </div>
                        <div class="panel-body">
